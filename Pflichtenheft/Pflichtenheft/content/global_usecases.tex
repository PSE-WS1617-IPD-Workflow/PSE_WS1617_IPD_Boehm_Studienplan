...
\begin{center}
	\resizebox{\textwidth}{!} {
		\input{diagrams/use_cases/profile-related}
	}
\end{center}

\begin{center}	
	\resizebox{\textwidth}{!} {
		\input{diagrams/use_cases/plan-related}
	}
\end{center}
...
\begin{usecase}{\lA{220}: Studienplan auf Korrektheit überprüfen}
	...
	\hline
	Der \glslink{Benutzer}{Nutzer} nimmt bei Bedarf Änderungen am Studienplan vor (\refA{140} bis \refA{175}). 
