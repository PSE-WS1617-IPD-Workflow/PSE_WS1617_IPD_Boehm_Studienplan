...
\begin{scenario*}{Bearbeitung eines Studienplans}
	...
	\item \nameref{A160}
	\item \nameref{A110} 
	\item \nameref{A150} und über das „Anker“"=Symbol eines Bestandteils davon \gls{hovern}
...
\begin{usecase}{\lA{40}: Profil bearbeiten}
	...
	& Dem Nutzer erscheint ein Formular zur Eingabe des aktuellen Studienstands: Er kann festlegen, welche Prüfungsleistungen er schon \glslink{Modul begonnen}{begonnen} und in welchem Semester er sie \glslink{Modul abgeschlossen}{bestanden} hat. Sechs leere Semester"=Zeilen sind als Startwert vorgegeben.\\
	\hline
...
\begin{usecase}{\lA{60}: Studienplan umbenennen}
	...
	\hline
	Nutzer gibt gewünschten Namen ein und bestätigt.
	& Das \gls{Popup} verschwindet und die vorherige Ansicht erscheint wieder, wobei sich der Name des Studienplans sich geändert hat.
\end{usecase}
...
\begin{usecase}{\lA{140}: Modul in Plan einfügen}
	{Bearbeitungsansicht, Studienplan geöffnet, mind. eine Semester"=Zeile vorhanden, mind. ein unplatziertes Modul oder \gls{Teilmodul} in der Suchleiste aufgelistet}
...
\begin{usecase}{\lA{150}: Modul mit Teilmodulen in Plan einfügen}
	{Bearbeitungsansicht, Studienplan geöffnet, mind. eine Semester"=Zeile vorhanden, mind. ein unplatziertes Modul mit \glslink{Teilmodul}{Teilmodulen} in der Suchleiste aufgelistet}
	...
	\hline
	Der Nutzer kann nun mit der Maus über das „Anker“"=Symbol eines Teilmoduls \gls{hovern}.
...
\begin{usecase}{\lA{220}: Studienplan auf Korrektheit überprüfen}
	...
	\hline
	Nutzer kann nun mit der Maus über fehlerhafte Module \gls{hovern}.
