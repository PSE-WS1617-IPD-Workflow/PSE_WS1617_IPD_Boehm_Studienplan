...
% usecase* environment
% #1: 3 + (number of lines of the first content row) // to fix ugly orphan-headings
% #2: Title of the use case
\newenvironment{usecase*}[2]{
	\needspace{#1\baselineskip} % Fix ugly orphan-heading 
	\subsubsection*{#2}  
...
\begin{usecase*}{13}{A150: Multimodul in Plan einfügen}
