...
\newglossaryentry{liken}
{
	name=liken,
	description={(ein \gls{Modul} liken): ein \gls{Modul} in den \gls{Like-Zustand} überführen}
}

\newglossaryentry{Like-Zustand}
{
	name=Like-Zustand,
	description={Zustand, in welchem ein \gls{Modul} vom Nutzer als erwünscht eingestuft wird}
}

\newglossaryentry{disliken}
{
	name=disliken,
	description={(ein \gls{Modul} disliken): ein \gls{Modul} in den \gls{Dislike-Zustand} überführen}
}

\newglossaryentry{Dislike-Zustand}
{
	name=Dislike-Zustand,
	description={Zustand, in welchem ein \gls{Modul} vom Nutzer als unerwünscht eingestuft wird}
}
