...
\newglossaryentry{Studienplan}
{
	name=Studienplan,
	plural=Studienpläne,
	description={Eine Zuordnung von Modulen zu Semestern, in welcher enthalten ist, wann welches Modul planmäßig \glslink{Modul begonnen}{begonnen} werden soll}
}
...
{
	name=Tooltip,
	description={Ein kleines rahmenloses Fenster mit Informationen, die beim überfahren mit der Maus auf der \gls{Weboberflaeche} eingeblendet wird}
}
