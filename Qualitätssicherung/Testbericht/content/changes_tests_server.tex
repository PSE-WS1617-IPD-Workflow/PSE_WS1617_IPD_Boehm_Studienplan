...
\begin{longtable}{| >{\hspace{0pt}} p{.26\textwidth} | >{\hspace{0pt}} p{.45\textwidth} | >{\hspace{0pt}} p{.19\textwidth} |}
	...
	\hline
	ContainsFilterDescriptorTest, ListFilterDescriptorTest, RangeFilterDescriptorTest, FilterDescriptorTest  & Korrekte JSON-Serialisierung, Parsen der Filterdaten aus einer Anfrage getestet; dabei auch ungültige Eingaben überprüft & ERFOLGREICH \\
	\hline
