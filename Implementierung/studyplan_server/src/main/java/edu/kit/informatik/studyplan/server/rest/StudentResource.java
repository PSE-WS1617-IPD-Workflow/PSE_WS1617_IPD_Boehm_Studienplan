...
public class StudentResource {
	...
	/**
	 * PUT-Anfrage:
	 * Ersetzt Informationen über einen Student und löscht die Verifikationsinformationen.
	 * @param jsonStudentInformation die Informationen über den Student als JSON Objekt.
	...
	/**
	 * GET-Anfrage:
	 * Gibt die Studentinformationen zurück.
