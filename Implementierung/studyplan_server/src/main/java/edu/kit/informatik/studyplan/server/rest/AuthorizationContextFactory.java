...
public class AuthorizationContextFactory implements Factory<AuthorizationContext> {
	...
	/**
	 * Only being called by Jersey. Retrieves an AuthorizationContext from a
	 * ContainerRequestContext's Property set before.
	 * 
	 * @return the context.
	 */
	@Override
	...
	/**
	 * Sets the requestContext's "authorizationContext" property to a given
	 * AuthorizationContext. To access the AuthorizationContext inside your REST
	 * resource class, use
	 * 
	 * <pre>
	 * <code>
	 ...
	 *            the requestContext whose property shall be set
	 * @param authorizationContext
	 *            the authorizationContext to assign
	 */
