...
/**
 * Encapsulates the module attribute names as string constants which are necessary for the filter architecture.
 * They are used during filter application inside the ModuleDao methods for unambigous identification of module
 * properties.
 * 
