define(["studyplan"], function (client) {
    ...
    describe("ModuleInitialisation", function () {
        it("testing parse", function () {
            ...
            expect(module1.get("constraints")[0].get("name")).toEqual(json.module.constraints[0].constraint.name);
            expect(module1.get("constraints")[0].get("first").get("name")).toEqual(json.module.constraints[0].constraint.first.module.name);
            expect(module1.get("constraints")[0].get("second").get("name")).toEqual(json.module.constraints[0].constraint.second.name);
            expect(module1.get("constraints")[0].get("type")).toEqual(json.module.constraints[0].constraint.type);
            expect(module1.get("constraints")[0].get("first").get("description")).toEqual(json.module.constraints[0].constraint.first.module["description"]);
