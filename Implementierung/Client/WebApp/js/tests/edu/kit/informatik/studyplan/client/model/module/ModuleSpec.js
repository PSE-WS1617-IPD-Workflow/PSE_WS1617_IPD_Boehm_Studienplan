define(["studyplan"], function (client) {
    ...
    describe("ModuleInitialisation", function () {
        it("testing parse", function () {
            ...
            expect(module1.get("preference").get("preference")).toEqual(json.module["preference"]);
            ...
            expect(module1.get("constraints")[0].get("first").get("name")).toEqual(json.module.constraints[0].first.name);
