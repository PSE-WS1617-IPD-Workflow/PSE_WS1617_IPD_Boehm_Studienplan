...
public class PlanModulesResource {
	 ...
	 *     -den gegebenen Filtern entsprechen, zurück.
	...
	/**
	 * GET Anfrage:
	 * Gibt eine JSON-Representation von dem Modul mit der gegebenen ID, der in dem Plan mit der gegebenen ID ist, zurück.
	 * @param planID ID des zu bearbeitenden Plans. 
	...
	/**
	 * PUT Anfrage: 
	 * fügt das Modul als JSON Objekt zur Plan mit den gegebenen ModulID bzw. PlanID hinzu.
	 * @param planID ID des zu bearbeitenden Plans. 
	 * @param moduleID ID des hinzuzufügenden Modul.
	 * @param jsonPutModule das Modul als Get-Parameter.
	...
	/**
	 * PUT-Anfrage:
	 * setzt eine Bewertung als JSON Objekt für den Modul mit der gegebenen ID, der im Plan mit der gegebenen ID.
	 * @param planID ID des zu bearbeitenden Plans. 
	 * @param moduleID ID des zu bewertenden Modul.
	 * @param jsonModulePreference die zu setzenden Bewertung des Moduls als GetParameters.
	...
	/**
	 * GET-Anfrage:
	 * Gibt den angefragten Filter zurück.
