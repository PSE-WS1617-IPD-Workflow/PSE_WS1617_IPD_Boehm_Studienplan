...
\begin{tikzpicture}
	...
	\node[attribute][below right = of module]{name} edge (module);
	\node[attribute, bool](compulsory)[above right = of module]{compulsory} edge (module);
	\node[attribute, num](creditpoints)[left = of module]{credit\_points} edge (module);	
	\node[attribute, enum](cycle)[below left = of module]{cycle\_type} edge (module);
