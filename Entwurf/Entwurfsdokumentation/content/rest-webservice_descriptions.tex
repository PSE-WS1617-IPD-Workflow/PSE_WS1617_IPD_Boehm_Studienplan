...
\input{content/json/Daniel}
\input{content/json/Hannes}
\input{content/json/Samuel}
...
\begin{longtable}{| >{\hspace{0pt}} p{.11\linewidth} | >{\hspace{0pt}} p{.26\linewidth} | >{\hspace{0pt}} p{.26\linewidth} | >{\hspace{0pt}} p{.27\linewidth} | }
	...
	% Wie harmoniert das mit JavaScript? Beides zusammen? PUT zu POST machen? Sont was?
