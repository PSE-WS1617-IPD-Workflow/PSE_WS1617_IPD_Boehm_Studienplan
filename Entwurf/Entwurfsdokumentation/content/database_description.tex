...
Ein Plan ist eindeutig über seine \texttt{plan\_id}, sowie über seinen \texttt{identifier} ansprechbar. Da die REST-Schnittstelle zum Zugriff den \texttt{identifier} verwendet, wird sichergestellt, dass nicht \enquote{durch Ausprobieren} auf einen beliebigen Plan zugegriffen werden kann.
\begin{figure}[H]
...
Eine Beschreibung der Attribute in Abbildung~\ref{fig:auth-er} findet sich in Kapitel~\ref{subsec:api-auth}.
\subsubsection{Enumwerte}
\begin{table}[h]
	\begin{tabular}{|l|l|}
		\hline
