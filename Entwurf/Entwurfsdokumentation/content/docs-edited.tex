...
\begin{texdocclassfields}
	...
	\texdocfield{private}{String}{cycleType}{Ob das Modul im Wintersemester (="WS"), Sommersemester (="SS") oder immer
		("both") stattfindet}
...
\begin{texdocclassfields}
	...
	\texdocfield{private}{int}{value}{Beschreibt die gesetzte Präferenz Einer der drei Werte $\{$"negativ",
		"positiv", ""$\}$}
\end{texdocclassfields}
\begin{texdocclassconstructors}
...
\begin{texdocclassfields}
	\texdocfield{private}{Collection\textless{}Discipline\textgreater{}}{disciplines}{Die Collection der Fächern}
\end{texdocclassfields}
\begin{texdocclassconstructors}
...
\begin{texdocclassfields}
	...
	\texdocfield{private}{String}{type}{Typ des Filters ("range", "list", "contains")}
\end{texdocclassfields}
\begin{texdocclassconstructors}
...
\begin{texdocclassfields}
	\texdocfield{private static}{String}{FALLBACK\_LANGUAGE}{Die Rückfall-Sprache des LanguageManagers}
...
\begin{texdocclassfields}
	\texdocfield{private}{String}{description}{Beschreibung der Objective Function}
	\texdocfield{private}{String}{name}{Name der Objective Function}
\end{texdocclassfields}
\begin{texdocclassconstructors}
...
\begin{texdocclassfields}
	\texdocfield{private}{Collection\textless{}ObjectiveFunction\textgreater{}}{objectivefunction}{Die Collection aller ObjectiveFunctions}
\end{texdocclassfields}
\begin{texdocclassconstructors}
...
\begin{texdocclassfields}
	...
	\texdocfield{private}{String}{studystartCycle}{Ob der Student im Sommer- (SS) oder Wintersemester (WS) angefangen hat zu
		studieren}
	\texdocfield{private}{int}{studyStartYear}{Das Jahr in dem der Student angefangen hat zu studieren}
...
\begin{texdocclassfields}
	...
	\texdocfield{private}{boolean}{isPreferencable}{Ob Module präferenzierbar sind (dies ist nur möglich, wenn sie im Kontext
...
\begin{texdocclassfields}
	\texdocfield{private}{boolean}{isPreferencable}{Ob die Module in den Boxen präferenzierbar sind (nur im Zusammenhang mit
		einem Plan)}
...
\begin{texdocclassfields}
	\texdocfield{private}{Plan}{plan}{Der Plan, welcher angezeigt wird.}
\end{texdocclassfields}
\begin{texdocclassconstructors}
...
\begin{texdocclassfields}
	\texdocfield{private}{Plan}{plan}{Der Plan, welcher angezeigt werden soll}
\end{texdocclassfields}
\begin{texdocclassconstructors}
...
\begin{texdocclassfields}
	...
	\texdocfield{private}{Collection\textless{}ModuleBox\textgreater{}}{moduleBox}{Die ModulBoxen, welche die Module des Semesters anzeigen}
	\texdocfield{private}{Semester}{moduleCollection}{Die Module, welche in dem Semester liegen}
	\texdocfield{private}{int}{number}{Variable, die angibt, das wie vielte Semester dieses ist (von 1 zählend)}
\end{texdocclassfields}
\begin{texdocclassconstructors}
\texdocconstructor{public}{Semester}{(Object params)}{}{}
\end{texdocclassconstructors}
...
\begin{texdocclassfields}
	...
	\texdocfield{private}{Plan}{plan}{Plan für welchen generiert werden soll}
\end{texdocclassfields}
\begin{texdocclassconstructors}
...
\begin{texdocclassfields}
	...
	\texdocfield{private}{NotificationCentre}{notificationCentre}{Der NotificationCentre, welcher die Anzeige von Benachrichtigungen
		übernimmt.}
...
server.generation.objectivefunction.PartialObjectiveFunction (siehe \ref{texdoclet:edu.kit.informatik.studyplan.server.generation.objectivefunction.PartialObjectiveFunction}).}{\begin{texdocparameters}
\texdocparameter{plan}{der zu bewertende Plan.}
\end{texdocparameters}
...
server.generation.Generator  (siehe \ref{texdoclet:edu.kit.informatik.studyplan.server.generation.Generator}).}{\begin{texdocparameters}
\texdocparameter{objectiveFunction}{Die Zielfunktion, anhand der optimiert werden soll}
\texdocparameter{currentPlan}{der bereits bestehende Plan}
\texdocparameter{moduleDAO}{die Module}
\end{texdocparameters}
...
server.verification.Verifier  (siehe \ref{texdoclet:edu.kit.informatik.studyplan.server.verification.Verifier}).}{\begin{texdocparameters}
