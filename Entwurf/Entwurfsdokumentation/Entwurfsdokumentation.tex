...
% fix hyphenation
\hyphenation{Log-out Log-in Ak-tions Ak-tion ge-öff-net liken dis-liken Like Dis-like No-ti-fi-ca-tion Mo-dule inkl Au-tho-ri-za-tion Web-App Ar-chi-tek-tur-en Ge-ne-rie-rungs Stu-di-en-plan}
...
\input{content/design_patterns}

\input{content/package_descriptions}
...
\input{content/canceled_features}

\input{content/implementation_plan}
\newpage
\begin{appendices}
